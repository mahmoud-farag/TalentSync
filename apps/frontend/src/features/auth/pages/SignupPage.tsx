...
import { AuthBrandHeader, AuthSocialRow, AuthTabs, SignupForm } from '../components';
import type { SignupFormData } from '../types';
import { useSignup } from '../store/hooks';
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <p className="mt-1 text-sm text-gray-500 lg:text-[15px]">
        Create your account to connect with opportunities and hiring teams.
      </p>
  
      <div className="mt-8 flex-1">
        <SignupForm onSubmit={handleSubmit} isLoading={loading} error={error} />
      </div>
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        ...
        <Link to="/login" className="font-semibold text-[#3b49a2] hover:text-[#323f8f]">
          Sign In
        </Link>
      </p>
